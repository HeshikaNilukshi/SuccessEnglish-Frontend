...
export default function SignInPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-bg-primary text-text-primary px-4 selection:bg-accent-indigo/30 overflow-hidden">
      {/* Glow Effects */}
      ...
      <div className="absolute bottom-[-10%] right-[10%] w-[500px] h-[500px] bg-accent-violet/6 rounded-full blur-[160px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-up">
        ...
        <div className="glass-panel rounded-2xl p-8 border border-white/[0.06] shadow-card relative overflow-hidden group">
          ...
          <div className="mt-8 text-center text-xs text-text-secondary">
            ...
            <Link to="/register" className="font-semibold text-accent-indigo hover:text-accent-violet transition-colors duration-200">
              Register
            </Link>
          </div>
        </div>
