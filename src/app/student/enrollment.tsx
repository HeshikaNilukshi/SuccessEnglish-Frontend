  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-10 pb-8 animate-pulse">
        ...
        <div className="h-10 w-64 bg-white/5 rounded mb-12" />
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-5 h-[350px] bg-white/5 rounded-2xl" />
          <div className="lg:col-span-7 h-[350px] bg-white/5 rounded-2xl" />
        </div>
      </div>
    )
  }
    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 pt-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch animate-fade-in-up animate-delay-100">
        <div className="lg:col-span-5">
          <div className="relative overflow-hidden rounded-2xl glass-panel border border-white/[0.04] p-8 shadow-xl h-full flex flex-col justify-between group">
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-bold text-white tracking-tight">{course.name}</h3>
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-mono bg-white/[0.03] border border-white/[0.06] px-2.5 py-1 rounded-lg text-text-secondary select-all">
                      ID: #{course.id}
                    </span>
                  </div>
                </div>
        ...
        <div className="lg:col-span-7">
          <form onSubmit={handleSubmit} className="relative overflow-hidden rounded-2xl glass-panel border border-white/[0.04] p-8 shadow-xl h-full flex flex-col group">
              ...
              >
                ...
                {receiptPreview ? (
                  <div className="space-y-4 my-auto flex flex-col items-center justify-center h-full w-full">
                    <div className="relative w-full max-w-[320px] flex-grow aspect-[4/3] rounded-xl overflow-hidden border border-white/10 bg-black/40">
                      <img
                        src={receiptPreview}
                        alt="Receipt Preview"
                    ...
                    <div className="shrink-0">
                      <p className="text-xs text-white font-semibold truncate max-w-[300px] mx-auto">
                        {receiptFile?.name}
                      </p>
                  ...
                  <div className="space-y-3 py-4 my-auto">
                    <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-xl mx-auto text-text-muted">
                      📄
                    </div>
