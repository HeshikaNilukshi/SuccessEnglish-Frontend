          ...
          <div className="relative overflow-hidden rounded-2xl glass-panel border border-white/[0.04] p-8 shadow-xl text-center group h-full flex flex-col justify-between">
            ...
            <div className="mt-8 pt-6 border-t border-white/[0.04] w-full">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-xs font-bold text-red-400 hover:text-red-300 bg-red-500/5 hover:bg-red-500/10 border border-red-500/10 hover:border-red-500/25 transition-all active:scale-[0.98] cursor-pointer"
              >
