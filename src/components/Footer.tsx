...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#2b3e5a] border-t border-white/10 py-16 z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4 pt-2">
            <a 
              ...
              className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-accent-indigo/20 hover:border-accent-indigo/50 transition-all duration-300"
              aria-label="Facebook"
            >
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
        <div>
