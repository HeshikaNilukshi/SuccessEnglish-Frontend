  ...
  return (
    <div className="relative z-30 self-start sm:self-auto">
      <button
        ...
        className="flex items-center gap-4 bg-white/[0.02] border border-white/[0.05] p-3 rounded-2xl hover:bg-white/[0.04] hover:border-white/10 active:scale-[0.98] transition-all cursor-pointer select-none text-left focus:outline-none focus:ring-1 focus:ring-accent-indigo/35"
      >
        ...
        <svg
          className={`w-4 h-4 text-text-muted transition-transform duration-200 shrink-0 ${isOpen ? 'rotate-180 text-white' : ''}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-3 w-52 rounded-2xl overflow-hidden bg-[#0d1120]/90 backdrop-blur-2xl border border-white/[0.07] shadow-[0_16px_48px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.03)] z-50 animate-popover-in origin-top-right">
            ...
            <div className="p-2 space-y-0.5">
              ...
              >
                ...
                <span className="text-sm font-semibold text-text-secondary group-hover:text-white transition-colors duration-150">
                  My Profile
                </span>
              </Link>
              ...
              >
                ...
                <span className="text-sm font-semibold text-text-secondary group-hover:text-red-400 transition-colors duration-150">
                  Sign Out
                </span>
              </button>
            </div>
