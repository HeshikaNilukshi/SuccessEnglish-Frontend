    ...
    <section id="contact" className="py-24 max-w-7xl mx-auto px-6 md:px-12 relative z-10 scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-6 flex flex-col justify-center">
          <h3 className="text-xl font-bold text-text-primary mb-2">Academy Contacts</h3>
          ...
          <div className="glass-panel p-5 rounded-xl border border-border-subtle flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-text-primary mt-1">+94 77 123 4567</p>
          ...
          <div className="glass-panel p-5 rounded-xl border border-border-subtle flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-text-primary mt-1">info@successenglish.lk</p>
          ...
          <div className="glass-panel p-5 rounded-xl border border-border-subtle flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-text-primary mt-1">Success English Academy</p>
          ...
          <div className="glass-panel p-5 rounded-xl border border-border-subtle flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-text-primary mt-1">Monday - Sunday</p>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <a
            ...
            className="group glass-panel p-8 rounded-2xl border border-border-subtle hover:border-[#25D366]/30 hover:bg-bg-secondary/85 transition-all duration-300 hover:shadow-[0_0_30px_rgba(37,211,102,0.06)] flex flex-col justify-between"
          >
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#25D366]/10 border border-[#25D366]/20 flex items-center justify-center mb-6 text-text-primary group-hover:bg-[#25D366]/20 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-text-primary mb-2 group-hover:text-[#25D366] transition-colors duration-300">WhatsApp Support</h3>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group glass-panel p-8 rounded-2xl border border-border-subtle hover:border-[#1877F2]/30 hover:bg-bg-secondary/85 transition-all duration-300 hover:shadow-[0_0_30px_rgba(24,119,242,0.06)] flex flex-col justify-between"
          >
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#1877F2]/10 border border-[#1877F2]/20 flex items-center justify-center mb-6 text-text-primary group-hover:bg-[#1877F2]/20 transition-all duration-300">
                <svg className="w-6 h-6 text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-text-primary mb-2 group-hover:text-[#1877F2] transition-colors duration-300">Facebook Community</h3>
              <p className="text-text-secondary text-sm leading-relaxed">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group glass-panel p-8 rounded-2xl border border-border-subtle hover:border-[#E1306C]/30 hover:bg-bg-secondary/85 transition-all duration-300 hover:shadow-[0_0_30px_rgba(225,48,108,0.06)] flex flex-col justify-between"
          >
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#E1306C]/10 border border-[#E1306C]/20 flex items-center justify-center mb-6 text-text-primary group-hover:bg-[#E1306C]/20 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-text-primary mb-2 group-hover:text-[#E1306C] transition-colors duration-300">Instagram Feed</h3>
              <p className="text-text-secondary text-sm leading-relaxed">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group glass-panel p-8 rounded-2xl border border-border-subtle hover:border-[#FF0000]/30 hover:bg-bg-secondary/85 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,0,0,0.06)] flex flex-col justify-between"
          >
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#FF0000]/10 border border-[#FF0000]/20 flex items-center justify-center mb-6 text-text-primary group-hover:bg-[#FF0000]/20 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-text-primary mb-2 group-hover:text-[#FF0000] transition-colors duration-300">YouTube Channel</h3>
              <p className="text-text-secondary text-sm leading-relaxed">
